...
Config.Translate = {
    ['CANNOT_START'] = "Vous ne pouvez pas lancer plusieurs feux d'artifice en même temps, attendez que celui en cours se termine", -- Uniquement si : Config.DisableMultiplyFireworks = true
    ['NEED_LIGHTER'] = "Vous avez besoin d'un briquet !", -- Uniquement si : Config.NeedLighter = true
    ['YOU_PLACE_FIREWORK'] = "Vous placez le feu d'artifice !",
}
